...
const obtenerObjetivos = async () => {
    ...
    const handleAhorroChange = (mes, value) => {
        const updatedAhorroMensual = ahorroMensual.map((ahorro) => {
            if (ahorro.mes === mes) {
                return { ...ahorro, valor_ahorro: parseFloat(value) || 0 }; // Actualiza el valor de ahorro
            }
            return ahorro;
        });
        setAhorroMensual(updatedAhorroMensual);
    ...
    return (
        <div className="p-4 max-w-6xl mx-auto">
            <h2 className="text-lg font-bold mb-4">Ahorro Programado</h2>
