...
function DropdownHelp({
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <span className="sr-only">Nesecitas ayuda?</span>
        <svg
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase pt-1.5 pb-2 px-3">Necesias ayuda?</div>
          <ul>
            <li>
              <Link
