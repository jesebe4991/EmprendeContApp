          ...
          <ul>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-gray-800 dark:text-gray-100">Funcionalidad de notificaciones</span> Esta en construccion y pendiente de implementar</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Sep 26, 2024</span>
              </Link>
            </li>
          </ul>
        </div>
