      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            {/* <svg className="bg-white" xmlns="http://www.w3.org/2000/svg" width={32} height={32}> */}
            <img src={logo}  alt="Mi logo" className="h-11 w-20"/>
              {/* <path d=/> */}
            {/* </svg> */}
          </NavLink>
        </div>
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname.includes("inbox") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Ahorro Programado</span>
                  </div>
                </NavLink>
              </li>
              {/* Calendar */}
